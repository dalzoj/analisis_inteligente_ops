...
def _load_prompt_file(filename):
    print('INFO: prompt_builder -> _load_prompt_file')
...
def get_chat_prompt():
    print('INFO: prompt_builder -> get_chat_prompt')
...
def get_code_gen_prompt():
    print('INFO: prompt_builder -> get_code_gen_prompt')
...
def get_code_insights_prompt():
    print('INFO: prompt_builder -> get_code_insights_prompt')
